...
const CHAMBERS = [
  {
    name: "Tattvapeetha",
    deva: "तत्त्वपीठा",
    essence: "A progressive ground for human development — the inner work that precedes everything else.",
    status: "Becoming available",
  },
  {
    name: "Traksha",
    deva: "त्रक्षा",
    essence: "The current digital practice — a quiet, slowly-built environment for reflective learning, continuity, and structured personal development.",
    status: "In active development",
  },
  {
    name: "Vanatattva",
    deva: "वनतत्त्वा",
    essence: "A considered space for men's wellness — physical, emotional, relational. Without bravado.",
    status: "On the horizon",
  },
  {
    name: "Shreetattva",
    deva: "श्रीतत्त्वा",
    essence: "A considered space for women's wellness — embodied, honest, unadorned by trend.",
    status: "On the horizon",
  },
  {
    name: "Raksha",
    deva: "रक्षा",
    essence: "Care for what is fragile — safety, dignity and quiet protection across the years of a life.",
    status: "On the horizon",
  },
];
