// Single source for note metadata + content.
// Adding a future note: append a new entry. The archive will pick it up automatically.

export interface Note {
  slug: string;
  title: string;
  date: string; // ISO date — used for sort + display
