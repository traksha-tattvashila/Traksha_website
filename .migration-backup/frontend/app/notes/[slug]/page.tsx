...
import { NOTES, getNote, formatNoteDate } from "@/lib/notes";
...
export async function generateMetadata({
  ...
  if (!note) return { title: "Note — Tattvashila" };
  return {
    title: `${note.title} — Quiet Notes — Tattvashila`,
