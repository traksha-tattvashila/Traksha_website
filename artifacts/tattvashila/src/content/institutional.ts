...
export const EYEBROW = {
  threshold:  "— a quiet body of work",
  premise:    "I \u00a0·\u00a0 The premise",
  philosophy: "II \u00a0·\u00a0 The ideas",
  ecosystem:  "III \u00a0·\u00a0 The work",
  journey:    "IV \u00a0·\u00a0 The journey",
  intake:     "V \u00a0·\u00a0 Stay in touch",
} as const;
...
export const SECTION_LABELS = {
  ...
  readOrigin:      "Read the origin",
  writeToUs:       "Write to us, quietly",
  sendQuietly:     "Send quietly",
  backToNotes:     "Back to Quiet Notes",
  readTheNote:     "Read the note",
} as const;
