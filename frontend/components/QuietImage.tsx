...
/**
 * QuietImage — restrained image element with graceful fallback.
 * Slow fade-in on load. Handles the SSR case where the image may already
 * be cached/decoded before React hydrates.
 */
export default function QuietImage({
  ...
  // After hydration, check if the image already finished loading.
  useEffect(() => {
